...
exports.PizzaCartOrder_OneItem = ejs.compile(fs.readFileSync('./Frontend/templates/PizzaCartOrder_OneItem.ejs', "utf8"));
exports.PizzaCart_OneItem = ejs.compile(fs.readFileSync('./Frontend/templates/PizzaCart_OneItem.ejs', "utf8"));
exports.PizzaType = ejs.compile(fs.readFileSync('./Frontend/templates/PizzaType.ejs', "utf8"));